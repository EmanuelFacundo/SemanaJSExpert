...
export default class Controller {
    ...
    async joinRoom(socketId, data){
        ...
        //todos usuarios que já estão conectados na mesma sala!
        ...
        //Avisar a rede que um novo usuario se conectou
        this.broadCast({
            socketId,
            roomId,
    ...
    broadCast({socketId, roomId, event, message, includeCurrentSocket = false }) {
        const usersRoom = this.#rooms.get(roomId)

        for( const [key, user] of usersRoom) {
